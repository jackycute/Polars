...
class emo.Modifier {
    ...
    function onUpdate() {
        ...
        //print("elapsed: " + elapsed() + " elapsedf: " + elapsedf + " percent: " + percent);
        //print(format("percent: %4.2f, elapsed: %4.2f, duration: %4.2f", percent, elapsedf, duration));
